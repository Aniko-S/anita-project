        ...
        <div class="grid-item-studies d-flex flex-wrap mt-5">
          <div class="col-12 col-md-6">
            ...
            <div>
              ...
              <list-item
                text="Természetgyógyászat (ETI): Bioenergetikus, Fülakupunktúrás Addiktológus"
              />
              <list-item text="Reiki Mester, Arolo" />
          ...
          <div class="col-12 col-md-6">
            ...
            <list-item
              text="Tréner (Vintage Akadémia) – Tudatosságfejlesztő Tréner"
            />
          </div>
        </div>
      </div>
